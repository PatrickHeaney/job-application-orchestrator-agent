...
## Instructions
1. **Load Inputs**:
   - Read `1job_posting.md`, `2strategy.md`, and `3resume.md` in `[ROOT]/20-user-applications/<folder_name>/`.
...
3. **Save Output**:
   - Save the prep guide as `6interview_prep.md` in `[ROOT]/20-user-applications/<folder_name>/6interview_prep.md`.
4. **Display to User**:
